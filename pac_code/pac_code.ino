...
void setup() 
{
  ...
  Serial.println(ghost_bk[10]);
  Serial.println(temp_ghost_bk[10]);
  Serial.println("------");
}
...
void loop() 
{
  ...
  for(int i = 0; i < 16; i++)
  {
    ...
    // temp_ghost_bk[i] = (uint16_t)temp_ghost_bk[i] << 1U;
    // temp_eyes_lt[i]  = (uint16_t)temp_eyes_lt[i]  << 1U;
    // temp_pup_lt[i]   = (uint16_t)temp_pup_lt[i]   << 1U;
    // temp_eyes_rt[i]  = (uint16_t)temp_eyes_rt[i]  << 1U;
    // temp_pup_rt[i]   = (uint16_t)temp_pup_rt[i]   << 1U;
